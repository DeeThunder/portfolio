...
- `/src/app`: Next.js App Router and global layout systems.
- `/src/components`: Modular UI components (Terminal, GUI sections, Navigation).
- `/public/data`: JSON-based project archives for easy updates.
